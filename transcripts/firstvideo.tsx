	...
	sections: [
		{
			...
			talks: [
				{
					text: 'ねえねえ魔理沙',
					speaker: 'reimu',
					id: '3fe56d56e4444cc4bff2b8c5fccded7e',
					audioDurationFrames: 29,
				},
				{
					text: 'なんだ霊夢',
					speaker: 'marisa',
					id: 'c52b6f1ee6384c5987a46dec66845caf',
					audioDurationFrames: 24,
				},
				{
					text: '私たちってめんどくさくない？',
					speaker: 'reimu',
					id: '999da84f370e4e5bbe02948c76a0b970',
					audioDurationFrames: 60,
				},
				{
					text: 'なんだ急にメンヘラみたいに',
					speaker: 'marisa',
					id: 'b711e25614e64af38d33052bf787562a',
					audioDurationFrames: 55,
				},
				{
					text: 'いや私たちってこうやって表情変えたり',
					speaker: 'reimu',
					id: 'edc8c1c24a4c437aa78c8d07e347a281',
					face: 'angry',
				...
				},
				{
					text: '口パクや瞬きさせたり',
					speaker: 'reimu',
					id: 'ce67888352dd4834b9b0f2e87c910e1c',
					audioDurationFrames: 55,
				},
				{
					...
					textForDisplay:
						'音声も一文一文音声ファイルを\n作ったりしているわけじゃない',
					speaker: 'reimu',
					id: '2df0a39e3da54318b19f3c1f1d97dbbd',
					face: 'donbiki',
				...
				},
				{
					...
					speaker: 'reimu',
					id: 'eec5c9f8d61040db9576cc76b687df97',
					audioDurationFrames: 90,
				},
				{
					text: 'そういうメタ的な話だったか',
					speaker: 'marisa',
					id: '9e498961fb7d4f1da5694100d6183405',
					audioDurationFrames: 65,
				},
				{
					text: 'それなら簡単な方法があるぜ',
					speaker: 'marisa',
					id: '89e875f4948a40fdbc6bcc019f8125cd',
					audioDurationFrames: 63,
				},
				{
					text: 'え、教えて教えて',
					speaker: 'reimu',
					id: '6d231d8686614268865b4e78c85de051',
				...
				},
				{
					...
					textForDisplay:
						'何を隠そう、今喋っている私たちも\nそれで作られているからな',
					speaker: 'marisa',
					id: 'f20f18a26acb4ecbb6c0128f70562052',
					audioDurationFrames: 141,
				},
				{
					text: 'え',
					speaker: 'reimu',
					id: 'c6581dd0a78344a0a8049c40fa2068b8',
				...
				},
				{
					...
					textForDisplay:
						'それじゃあプログラミングで\nゆっくり実況を作る方法を解説していくぜ',
					speaker: 'marisa',
					id: 'd23ef3723273492b80b7f2d4ec35e255',
					audioDurationFrames: 147,
				},
				{
					text: 'それでは',
					speaker: 'marisa',
					id: '218b5c7bbb0d4fae823d139b9c246d71',
				...
				},
				{
					...
					ids: [
						'45190ee1ee754eb1999aa809b0bfb3a3',
						'e0bb06730acb4d7ba0680e449e49a8ce',
					],
				},
			],
			totalFrames: 1661,
			...
			reimuKuchipakuMap: {
				...
				amplitude: [
					6, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2,
				],
			},
		...
		},
		{
			...
			talks: [
				{
					...
					speaker: 'reimu',
					id: 'a7e1b692fa104e5fb564b17f19170b9a',
				...
				},
				{
					...
					speaker: 'marisa',
					id: '4e906ab88acc4d2b84239749e801b1f1',
				...
				},
				{
					text: 'Remotion?',
					speaker: 'reimu',
					id: 'a9b17699dc0b485494ab234671534f57',
					image: {src: '/image/remotion-logo.png', backgroundColor: '#fff'},
				...
				},
				{
					...
					speaker: 'marisa',
					id: '4b1fe03e55ac4dec818ce6c89b76e6b2',
					image: {src: '/image/remotion-logo.png', backgroundColor: '#fff'},
				...
				},
				{
					text: 'React?',
					speaker: 'reimu',
					id: 'c64b9b32b723417da4801f0190c2ae16',
					audioDurationFrames: 18,
				},
				{
					text: 'ちょっと知らない単語がいっぱいだわ',
					speaker: 'reimu',
					id: '9214e630a2fe472e8b9194b79054ec9e',
					audioDurationFrames: 66,
				},
				{
					text: '順に説明して',
					speaker: 'reimu',
					id: '12dd6898441b4369881dc45fab238233',
					audioDurationFrames: 38,
				},
				{
					text: 'わかったぜ',
					speaker: 'marisa',
					id: '648afc98384445879c329b85ca7e14c0',
				...
				},
				{
					...
					speaker: 'marisa',
					id: 'ff02aa0f26054d9c913ae8ffbaf64039',
				...
				},
				{
					...
					speaker: 'marisa',
					id: '0008d9542dc94ff7a2b29631d546592f',
				...
				},
				{
					...
					speaker: 'marisa',
					id: '7604f55e168744e089fbfd28dc937fdb',
					image: {src: '/image/html_css_javascript.jpeg'},
				...
				},
				{
					...
					speaker: 'marisa',
					id: 'cca98716999847209a8b2d60a69f9f90',
				...
				},
				{
					text: 'これが私たちの顔...!',
					speaker: 'reimu',
					id: '57feb484f18d4722a083fb723c4646ef',
					image: {src: '/image/react-face-sample.png'},
				...
				},
				{
					text: '...これは...便利なの？',
					speaker: 'reimu',
					id: '8d1d163d801d4810975a34b8b8ec4ba6',
					image: {src: '/image/react-face-sample.png'},
					audioDurationFrames: 65,
				},
				{
					...
					textForDisplay:
						'まあとりあえずWebサイトの見た目を\n作れるものと覚えていてくれ',
					speaker: 'marisa',
					id: '878d65ca3c4f4724926f091e38c5fce1',
					audioDurationFrames: 131,
				},
				{
					text: 'わかったわ',
					speaker: 'reimu',
					id: '380358a611be4618bb92ac48eb649c18',
				...
				},
				{
					...
					speaker: 'marisa',
					id: '6d28eddac7f34dc5b1ddf714c20adff1',
				...
				},
				{
					...
					speaker: 'reimu',
					id: 'cb1cc8f7306541e78f77bb31d3b8ad5d',
				...
				},
				{
					...
					textForDisplay:
						'ああ、だからこれが最初に出てきた時は\nエンジニアたちも驚いてたぜ',
					speaker: 'marisa',
					id: '53c2a330b4144901b4ebab99b60e1e3d',
					audioDurationFrames: 141,
				},
				{
					...
					speaker: 'marisa',
					id: '28b91b946eb248208e8bd31d0d482aa5',
					audioDurationFrames: 99,
				},
				{
					text: 'こういう動画が作れるんだ',
					speaker: 'marisa',
					id: 'c687fb33dba04d1684b0feeda652d66e',
					audioDurationFrames: 50,
				},
				{
					text: 'えーすごい！',
					speaker: 'reimu',
					id: '5c874f963e0b41c7b38aab8b5bc86ade',
				...
				},
				{
					...
					textForDisplay:
						'こんなただのテキストが\n動画になるなんてなんだか不思議だわ',
					speaker: 'reimu',
					id: '444da86a56f5416fa393f4a8aa96827d',
					audioDurationFrames: 118,
				},
				{
					text: 'だろ',
					speaker: 'marisa',
					id: '0f77ff723db84264a498dd567517da15',
				...
				},
				{
					...
					speaker: 'reimu',
					customDuration: 120,
					id: 'bb467592347f46a79d154141f216cb45',
				...
				},
				{
					...
					textForDisplay:
						'そういえば私たちも\nこれで作られてるって言ってたけど',
					speaker: 'reimu',
					id: '8af88c2375a24070a5a10ddec4fbef60',
					audioDurationFrames: 117,
				},
				{
					text: 'それはどんな風に作られているのかしら？',
					speaker: 'reimu',
					id: '6fbf4cf8e4ac4ddf8759b1be5944b794',
					audioDurationFrames: 79,
				},
				{
					text: '次はそれについて話していこうか',
					speaker: 'marisa',
					id: '79bec780571b4cdaa8a5b67894a56dd6',
					audioDurationFrames: 66,
				},
				{
					text: '楽しみだわ！',
					speaker: 'reimu',
					id: '3c21f3fd86114181a0fc29e4a81a8c5b',
			...
			reimuKuchipakuMap: {
				...
				amplitude: [
					...
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					...
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 6, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
				],
			},
			marisaKuchipakuMap: {
				frames: [
		...
		},
		{
			...
			talks: [
				{
					...
					textForDisplay:
						'それじゃあ私たちがどんな感じで\n作られているか見ていくぜ',
					speaker: 'marisa',
					id: '8211ca9b7348496c9e12dd83a4cf6991',
					audioDurationFrames: 122,
				},
				{
					text: 'ワクワク',
					speaker: 'reimu',
					id: '2210b326b28e4200bc1233a2a3c5493a',
					audioDurationFrames: 20,
				},
				{
					text: 'まずは字幕だな',
					speaker: 'marisa',
					id: '0e4927fc3f8547abb065180272419a48',
				...
				},
				{
					...
					textForDisplay:
						'字幕はすごいシンプルでテキストを書いて\nCSSで見た目を変えるだけだぜ',
					speaker: 'marisa',
					id: '00a1f13ca1d7406ea87bc75191603374',
					audioDurationFrames: 148,
				},
				{
					text: 'こんな感じだな',
					speaker: 'marisa',
					id: '5998a2b446a74c53845e1ee8ce760aba',
				...
				},
				{
					text: 'とてもシンプルね。',
					speaker: 'reimu',
					id: 'e17c05dc821f4f7fb22bab31d8ca020c',
					image: {src: '/image/jimaku-code.png'},
					audioDurationFrames: 35,
				},
				{
					...
					speaker: 'marisa',
					id: '3fd458cccd9f4e348d0839c0a71a2b8a',
				...
				},
				{
					text: 'うわ、鬱陶しい',
					speaker: 'reimu',
					id: '6d6cff4b4bbd4c8981dcce4653223840',
					customObjectKey: 'gunyogunyo',
					image: {src: '/image/css-animation-sample.png'},
					audioDurationFrames: 38,
				},
				{
					...
					speaker: 'marisa',
					id: '2657afda179f4330b4ba01fc8a09c4e8',
					image: {src: '/image/css-animation-sample.png'},
				...
				},
				{
					...
					speaker: 'marisa',
					id: '90bb1565fb634a9a98872ef347cbe7e5',
					audioDurationFrames: 73,
				},
				{
					text: 'こんな感じの設定ファイルに記述しているぜ',
					speaker: 'marisa',
					id: 'd3fbba9e1b834931ba55f5c2e9a64da7',
					customDuration: 120,
				...
				},
				{
					text: 'つまりこんな感じで書けば',
					speaker: 'marisa',
					id: 'a901b47829314076b7f4f8e12e5d4b66',
				...
				},
				{
					...
					speaker: 'reimu',
					id: '395fffab7c2447b7af21b2cb5c59d2b5',
					image: {src: '/image/reimu-talking-setting.png'},
				...
				},
				{
					...
					speaker: 'marisa',
					id: 'f6d4d29788e14c809ba6a1b5beab2128',
					audioDurationFrames: 92,
				},
				{
					text: 'はっ...私は一体今何を',
					speaker: 'reimu',
					id: '471eda7a9fe7483b8dd77b2edcedf937',
					audioDurationFrames: 78,
				},
				{
					text: '次に音声の流し方だが、',
					speaker: 'marisa',
					id: '572f2977a5944c2f8e2ae37b0c0418ad',
				...
				},
				{
					...
					textForDisplay:
						'Audioというものがあるからこれで\n音声ファイルのパスを指定するだけだな',
					speaker: 'marisa',
					id: '3d017f903fa9452a9601325cf99fc057',
				...
				},
				{
					text: '例えばこんな感じだ',
					speaker: 'marisa',
					id: '44e02865a48f4f579632d9698f970438',
					customDuration: 160,
				...
				},
				{
					...
					speaker: 'reimu',
					delayFrames: 30,
					id: '23917a16c27d4827aa24098d0a5a3666',
					audioDurationFrames: 80,
				},
				{
					text: '作者だ。',
					speaker: 'marisa',
					id: 'd6bf0c5fc5d242ee9772e126ae54ab79',
					audioDurationFrames: 20,
				},
				{
					text: '作者？',
					speaker: 'reimu',
					id: '91ebb92a44464f4f83b7f98debe9cdd6',
					audioDurationFrames: 17,
				},
				{
					text: 'お次は動画を表示してみるぜ',
					speaker: 'marisa',
					id: 'b561cec9cf124269acd7925223bce9e3',
					audioDurationFrames: 58,
				},
				{
					text: 'ちょっと...',
					speaker: 'reimu',
					id: 'e9a8aa6ae1894223bf5c8718c19e8c86',
					audioDurationFrames: 16,
				},
				{
					text: 'と言っても動画もほぼ一緒だ。',
					speaker: 'marisa',
					id: 'a70d6bebe7614d379d25d560e024fa55',
				...
				},
				{
					...
					speaker: 'marisa',
					id: 'd825ed6a5ee241d3ba4f4fef7599eee5',
					image: {src: '/image/video-code-sample.png'},
					audioDurationFrames: 139,
				},
				{
					text: 'あらかわいい',
					speaker: 'reimu',
					id: '7bea48550313407f99075a496eaee144',
					audioDurationFrames: 22,
				},
				{
					text: '作者が最近飼い始めた猫のルイ君だな',
					speaker: 'marisa',
					id: 'ad2dfddc144c4e31b6411b8ad2c6c865',
					audioDurationFrames: 94,
				},
				{
					text: '作者...一体誰なの...',
					speaker: 'reimu',
					id: '2087f7613cd24db19e4ec1523dc63b37',
			...
			reimuKuchipakuMap: {
				...
				amplitude: [
					6, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
				],
			},
			marisaKuchipakuMap: {
				frames: [
		...
		},
		{
			...
			talks: [
				{
					text: 'ところでなんだけど',
					speaker: 'reimu',
					id: 'e50a95c4ec0f4178808c1432e174f245',
					audioDurationFrames: 37,
				},
				{
					text: 'プログラミングで動画が作れると何が嬉しいのかしら？',
					speaker: 'reimu',
					id: '2db6bdf683884a7bba7f549fb3319ed3',
					audioDurationFrames: 112,
				},
				{
					text: 'だって世の中には高性能な動画制作ツールがたくさんあるじゃない？',
					speaker: 'reimu',
					id: 'c5722cfa10a440ab83f36561ab35a0dd',
					audioDurationFrames: 147,
				},
				{
					text: 'いい質問だな',
					speaker: 'marisa',
					id: 'ba48ea41535f42acbf4be0cf3e9340fb',
					audioDurationFrames: 30,
				},
				{
					text: 'メリットはいくつかあるぜ',
					speaker: 'marisa',
					id: '1bd772a6e45446a694d93d80bcf48346',
				...
				},
				{
					...
					speaker: 'marisa',
					id: 'b342d3e01c3442d7bf7c3bea0ac96e4a',
					audioDurationFrames: 186,
				},
				{
					text: 'そんなことあるかしら？',
					speaker: 'reimu',
					id: '6e99e0a15202480dbfb5a1b0224cf2ec',
				...
				},
				{
					...
					speaker: 'marisa',
					id: 'ed3e90918a0b4171b16f08b969dbd6a0',
				...
				},
				{
					...
					speaker: 'marisa',
					id: '96773ff9124540b2ba3239b0ebac1a09',
					audioDurationFrames: 178,
				},
				{
					text: 'ユーザのデータ毎に違う動画が動的に作れるんだ',
					speaker: 'marisa',
					id: '680e8682c6e34f99b3cfe7e5a086fbd4',
				...
				},
				{
					...
					speaker: 'reimu',
					id: '4143670b041742a384e0dce27b3f48a8',
					audioDurationFrames: 171,
				},
				{
					text: 'あとは複数の言語に対応する時だな',
					speaker: 'marisa',
					id: 'e3c9806753464af49f8d578761cc910e',
					audioDurationFrames: 87,
				},
				{
					text: 'なるほど！それはビジネスとかに便利そうね！',
					speaker: 'reimu',
					id: '7d573b86cf954f6b9b97598b3179f606',
					audioDurationFrames: 90,
				},
				{
					...
					speaker: 'marisa',
					id: 'c2d9447f3c21492181d0c3d564c832e6',
					audioDurationFrames: 186,
				},
				{
					...
					speaker: 'marisa',
					id: '5639da261e244cbaa2241cfbb7fa2c7c',
					audioDurationFrames: 175,
				},
				{
					text: 'Our English is super horrible',
					speaker: 'reimu',
					id: 'f3fa67fdfb1d4f84bf92bdeda598911e',
					audioDurationFrames: 122,
				},
				{
					...
					textForDisplay:
						'その他にもプログラミングで作れると\n色々自由度高く繋げられるのが便利だな',
					speaker: 'marisa',
					id: '4b1f3d7da63f41dcbfbabeeb9b182caf',
				...
				},
				{
					...
					speaker: 'marisa',
					id: 'fc2caabdcb124b61a0a1ed67aaa1687a',
					audioDurationFrames: 200,
				},
				{
					text: 'あとこれはエンジニアとして思ったことなんだが、',
					speaker: 'marisa',
					id: '7e3493094674411c83eec2711ef36009',
					audioDurationFrames: 88,
				},
				{
					...
					speaker: 'marisa',
					id: 'f24b35c6cfd04dd7835fcd2923066135',
					audioDurationFrames: 202,
				},
				{
					text: 'だからエンジニアには自信を持ってオススメできるな',
					speaker: 'marisa',
					id: 'f1b27016850f405995c198cc18d8e51f',
					audioDurationFrames: 99,
				},
				{
					text: 'へー',
					speaker: 'reimu',
					id: 'c2581b4afffe42f8ab26d65baf16a1df',
				...
				},
				{
					...
					textForDisplay:
						'こう聞くといいことばかりな\n気がするけど逆に欠点はないの',
					speaker: 'reimu',
					id: '45e9926b2d4e433b8bc673237f30e2a7',
				...
				},
				{
					...
					speaker: 'marisa',
					id: '4991104fc6ac40abbd30293c6389e576',
				...
				},
				{
					...
					speaker: 'marisa',
					id: '98fe6c1aeea44690a0327c36f08a821b',
					audioDurationFrames: 243,
				},
				{
					text: 'まあ...それはそうよね',
					speaker: 'reimu',
					id: '6025bb16b203441487d0bc5d31450751',
				...
				},
				{
					...
					textForDisplay:
						'あとはトランジションやエフェクトなどは\nやはり動画制作ツールに負けるな',
					speaker: 'marisa',
					id: 'e994356736b147f996091813a5180aa1',
				...
				},
				{
					...
					speaker: 'marisa',
					id: '6f58434f5a234a47945a69fe9dcb6a79',
				...
				},
				{
					...
					speaker: 'reimu',
					id: '07ce15824987432d9264b19d8d7d9eec',
				...
				},
				{
					...
					speaker: 'marisa',
					id: 'a3076fe630d9478b8a5bf8f4749062cb',
					audioDurationFrames: 181,
				},
				{
					text: 'この朴訥さが有利に働くなんてすごいわね私たち！',
					speaker: 'reimu',
					id: '478f4861ef6c49909b6b03aa31b68dc8',
			...
			reimuKuchipakuMap: {
				...
				amplitude: [
					6, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					...
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
		...
		},
		{
			...
			talks: [
				{
					...
					speaker: 'reimu',
					id: 'dd6075770b0043fcbab1d84046032974',
					audioDurationFrames: 106,
				},
				{
					text: 'ああ、これでリッチな動画がたくさん作れるようになるな',
					speaker: 'marisa',
					id: '7602f9b968a64f2284478f7b1dde1551',
				...
				},
				{
					...
					textForDisplay:
						'いろんなサイトで動画が作られることが\n増えるかもしれないぜ',
					speaker: 'marisa',
					id: 'cad16dfa49b04ddc85e617250780d129',
				...
				},
				{
					...
					speaker: 'reimu',
					id: '6c85581df5e04c3daf9207e7aa52bd18',
					audioDurationFrames: 135,
				},
				{
					text: 'いきなりアイデンティティが崩壊しちゃった',
					speaker: 'reimu',
					id: '621615c9e3944fa89146daf4ce440656',
					audioDurationFrames: 71,
				},
				{
					text: 'そうだな',
					speaker: 'marisa',
					id: '0185c4c3914645188df69be4be2bac00',
					audioDurationFrames: 18,
				},
				{
					...
					textForDisplay:
						'もしかしたら今これを見ている\n"あなた"もそうだったりしてな',
					speaker: 'marisa',
					id: 'b55188c7e9ab49bdabd7377a9bbd4480',
					audioDurationFrames: 124,
				},
				{
					text: '？',
					speaker: 'reimu',
					id: 'b5170b169fff4143ade369f260acfb4b',
					audioDurationFrames: 0,
				},
				{
					text: '誰に向かって話しかけてるの？',
					speaker: 'reimu',
					id: 'ab489f1028a64a6a98521ac804a880fd',
					audioDurationFrames: 62,
				},
				{
					text: 'なんでもないぜ',
					speaker: 'marisa',
					id: 'fa3607ed5ba14019a5cfe178708c11d3',
					audioDurationFrames: 28,
				},
				{
					text: 'そろそろこの動画も終わりにしようか',
					speaker: 'marisa',
					id: 'f0cc939772904bd38b3177bfd5001a38',
					audioDurationFrames: 68,
				},
				{
					text: 'そうね',
					speaker: 'reimu',
					id: '297e247d803c4af9b20663f6b6c0bf63',
					audioDurationFrames: 15,
				},
				{
					text: 'それでは',
					speaker: 'marisa',
					id: '7e96de94b4b240ba8172768ca2d98907',
					audioDurationFrames: 18,
				},
				{
					...
					ids: [
						'f5308fab929f4b4bb6f44582cd74ba8e',
						'2590660060d74671b17c63a5fc7d9630',
					],
					audioDurationFrames: 96,
				},
			],
			...
			reimuKuchipakuMap: {
				...
				amplitude: [
					...
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4,
					2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
					4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4,
					6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2,
					4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0,
					2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2, 0, 2, 4, 6, 4, 2,
					0, 2, 4, 6, 4, 2, 0, 2, 4, 6,
